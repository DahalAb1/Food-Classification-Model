...
I've built this model to learn how I would be able to solve classification problmes in python using pyTorch. I've been exposed to many technologies while working in this project. I've understood the flexibility of python and many usecases this language has. 

  I've got strong mathematics background. Things have been pretty digestible till this point. 
 From here on I will shift my focus into the world of NLP's. 
